...
#+END_CENTER
** Espectro
El proceso para crear un espectro, mediante FFT, es romper la onda temporal en sus partes constituyentes (ondas sinusoidales de diferente frecuencia y amplitud).[fn:5]
#+BEGIN_CENTER
