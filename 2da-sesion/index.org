...
El primer paso para seleccionar el sensor es elegir *que necesitamos medir* (Desplazamiento, Velocidad, Aceleración). Para este paso se tienen en consideración el *tipo de apoyo* y la *velocidad de la máquina*.
